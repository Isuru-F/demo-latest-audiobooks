    ...
    <section class="audiobooks">
      <div class="audiobooks-header">
        ...
        <div class="controls-container">
          ...
          <button 
            ...
            :title="multiCastOnly ? 'Showing multi-cast audiobooks only' : 'Show all audiobooks'"
          >
      ...
      <div v-else>
        <p v-if="filteredAudiobooks.length === 0" class="no-results">
          {{ multiCastOnly ? 'No multi-cast audiobooks match your search.' : 'No audiobooks match your search.' }}
        </p>
...
.multi-cast-toggle:hover {
  border-color: #8a42ff;
  box-shadow: 0 4px 15px rgba(138, 66, 255, 0.15);
}
